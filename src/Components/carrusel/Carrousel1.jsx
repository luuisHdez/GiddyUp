      ...
      <div className="flex gap-5 max-md:flex-col">
                ...
                <div className="flex flex-col max-md:w-full">
                  ...
                  <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                      ...
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.1.content.0.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.1.content.0.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                      <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.1.content.1.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.1.content.1.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                    <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.1.content.2.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.1.content.2.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                    <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.1.content.3.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.1.content.3.description')}</span>
                      </div>
                    </div>
                </div>
                </div>
        ...
        <div className="flex flex-col ml-5 w-6/12 max-md:w-full max-md:ml-0">
          <div className="flex flex-col justify-center p-9 w-full bg-sky-50 bg-opacity-10 rounded-[1000px] max-md:w-full max-md:px-5 max-md:mt-10">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=100%20100w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=200%20200w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=400%20400w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=800%20800w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=1200%201200w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=1600%201600w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&width=2000%202000w,%20https://cdn.builder.io/api/v1/image/assets/TEMP/35ffb981861510378b8b70f0572fb7c178e100660817d80031216b6ee3c2e527?apiKey=c1946530cef5422ab7dda9568063bfde&" alt="Needs illustration" className="object-contain w-full aspect-[0.95] max-md:max-w-full" />
          </div>
        </div>
      </div>
    </section>
