                ...
                <div className="flex flex-col max-md:w-full">
                  ...
                  <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                      ...
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.2.content.0.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.2.content.0.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                      <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.2.content.1.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.2.content.1.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                    <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.2.content.2.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.2.content.2.description')}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-8 max-w-full w-[675px] max-md:w-full">
                    <img loading="lazy" src={"https://cdn.builder.io/api/v1/image/assets/TEMP/42fec9c3bc40acd2b6bcc9eeed10f0ec520613981a6df7662db45320f1b15bcb?apiKey=c1946530cef5422ab7dda9568063bfde"} alt="" className="object-contain shrink-0 w-8 aspect-square" />
                      <div className="flex-auto max-md:w-full">
                        <span className="font-medium underline text-zinc-300">{t('carouselItems.2.content.3.title')}</span>
                        <span className="font-medium text-zinc-300">:</span>{" "}
                        <span className="font-medium text-white">{t('carouselItems.2.content.3.description')}</span>
                      </div>
                    </div>
                  </div>
                </div>
